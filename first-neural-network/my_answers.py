...
class NeuralNetwork(object):
    def __init__(self, input_nodes, hidden_nodes, output_nodes, learning_rate):
        ...
        # as shown below.
        self.activation_function = lambda x : (1.0 + np.exp(-x))**-1  # Replace 0 with your sigmoid calculation.
    ...
    def backpropagation(self, final_outputs, hidden_outputs, X, y, delta_weights_input_hidden, delta_weights_hidden_output):
        ...
        output_error_term = error # since the derivative of the output function (f(x) =x) is 1
